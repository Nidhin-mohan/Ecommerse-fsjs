...
const { createOrder, getOneOrder, getLoggedInOrders, adminDeleteOrder, adminUpdateOrder, admingetAllOrders, cancelOrder, generateRazorpayOrderId } = require("../controllers/order.controller");
const { isLoggedIn, customRole } = require("../middlewares/auth.middleware");
const { ADMIN } = require("../utils/authRoles");

router.route("/order/razorpay").post(isLoggedIn, generateRazorpayOrderId);
